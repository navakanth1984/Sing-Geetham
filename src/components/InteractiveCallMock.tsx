    ...
    <div id="call_mock_layout_section" className="grid grid-cols-1 md:grid-cols-5 gap-6 text-slate-200">
      ...
      <div className="md:col-span-2 space-y-4">
        ...
        <div className="bg-white/5 p-5 rounded-2xl border border-white/10 shadow-xl space-y-3">
          ...
          <label className="flex flex-col items-center justify-center p-5 border border-dashed border-white/10 hover:border-amber-500/50 rounded-xl cursor-pointer bg-black/40 hover:bg-white/5 transition-all focus-within:ring-2 focus-within:ring-amber-500 focus-within:ring-offset-2 focus-within:ring-offset-black">
            <input 
            ...
            <div className="flex gap-2">
              ...
              {isCallActive && isSingingMode && (
                <button
                  ...
                  disabled={isLoading}
                  className="bg-white/5 hover:bg-white/10 border border-white/10 p-2.5 rounded-lg text-amber-500 transition flex items-center justify-center focus-visible:ring-2 focus-visible:ring-amber-500 outline-none"
        ...
        <div className="space-y-4 z-10 pt-4 border-t border-white/10">
          ...
          <div className="flex justify-center items-center gap-4 pt-1">
            <button
              ...
              className={`p-4 rounded-full transition-all shadow-xl flex items-center justify-center focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A0A0B] focus-visible:ring-amber-500 outline-none ${
                isCallActive 
