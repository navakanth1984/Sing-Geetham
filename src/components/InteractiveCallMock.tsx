    ...
    <div id="call_mock_layout_section" className="grid grid-cols-1 md:grid-cols-5 gap-6 text-slate-200">
      ...
      <div className="md:col-span-2 space-y-4">
        ...
        <div className="bg-white/5 p-5 rounded-2xl border border-white/10 shadow-xl space-y-3">
          ...
          <label className="flex flex-col items-center justify-center p-5 border border-dashed border-white/10 hover:border-amber-500/50 focus-within:border-amber-500/50 focus-within:ring-2 focus-within:ring-amber-500/20 rounded-xl cursor-pointer bg-black/40 hover:bg-white/5 transition-all">
            <input 
